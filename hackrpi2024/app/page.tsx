...
const App: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center max-w-[100rem] mx-auto ">
      ...
      <div className="flex gap-3 items-center justify-center mt-[16rem]">
        <Image
          src="/MangoPair.png"
          alt="MangoMaps logo"
          width={0}
          ...
          sizes="50vw"
        />
        <h1 className={`text-7xl font-bold text-center ${doto.className}`}>
          Mango Maps
        </h1>
      </div>
      ...
      <Link
        href="/map"
        className="text-lg flex mt-8 gap-2 items-center justify-center bg-orange-500 py-3 px-5 rounded-2xl text-white hover:gap-4 hover:px-4 duration-150"
      >
